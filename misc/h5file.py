...
motgt = pd.read_csv("keypoint_train_resize.txt", sep=" ", index_col = False)
#motgt = motgt.loc[:,'1':'41']
motgt = motgt.drop(motgt.columns[[0]],axis=1)
final = motgt.as_matrix()
#print(np.shape(final))
final=np.reshape(final,(771000,2))
#final=final[0:38631]
np.savetxt('part_resize2.txt', final, delimiter=',',fmt='%.0f')
print(final)
DATASET1='istrain'
