...
keys = ['index','person','imgname','center','scale'] #index','person','imgname','center','scale','part','visible','normalize','torsoangle','multi','istrain']
...
with h5py.File('mpii-annot-keypoint.h5','w') as f:
    f.attrs['name'] = 'mpii'
    for k in keys:
